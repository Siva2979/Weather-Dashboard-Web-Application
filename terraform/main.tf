...
locals {
  public_key_file = var.public_key_path != "" ? pathexpand(var.public_key_path) : ""
  use_key_pair    = local.public_key_file != "" && fileexists(local.public_key_file)
}
...
resource "aws_instance" "app" {
  ...
  key_name               = local.use_key_pair ? aws_key_pair.app[0].key_name : null
